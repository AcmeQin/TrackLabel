...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    private List<MyBluetoothDev> bluetoothDevList;
    ...
    public void onBindViewHolder(ViewHolder holder, int position){
        ...
        switch (myBluetoothDev.getDevClass()){
            case BluetoothClass.Device.TOY_VEHICLE: d=mContext.getDrawable(R.drawable.default_icon);
                break;
            case BluetoothClass.Device.PHONE_SMART: d=mContext.getDrawable(R.drawable.smartphone);
                break;
            case BluetoothClass.Device.COMPUTER_LAPTOP: d=mContext.getDrawable(R.drawable.notebook);
                break;
            case BluetoothClass.Device.AUDIO_VIDEO_HEADPHONES: d=mContext.getDrawable(R.drawable.headphones);
                break;
            case BluetoothClass.Device.COMPUTER_HANDHELD_PC_PDA: d=mContext.getDrawable(R.drawable.tablet);
                break;
            case BluetoothClass.Device.TOY_GAME: d=mContext.getDrawable(R.drawable.gaming);
                break;
            case BluetoothClass.Device.AUDIO_VIDEO_VIDEO_CAMERA: d=mContext.getDrawable(R.drawable.camera);
                break;
            default: d=mContext.getDrawable(R.drawable.default_icon);
                break;
        }
